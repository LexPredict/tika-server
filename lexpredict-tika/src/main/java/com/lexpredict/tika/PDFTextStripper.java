...
public class PDFTextStripper extends LegacyPDFStreamEngine
{
    ...
    static
    {
        ...
        try
        {
            String className = org.apache.pdfbox.text.PDFTextStripper.class.getSimpleName().toLowerCase();
    ...
    protected void writePage() throws IOException
    {
        ...
        PDFTextStripper.PositionWrapper lastPosition = null;
        PDFTextStripper.PositionWrapper lastLineStartPosition = null;
        ...
        for (List<TextPosition> textList : charactersByArticle)
        {
            ...
            List<PDFTextStripper.LineItem> line = new ArrayList<PDFTextStripper.LineItem>();
            ...
            while (textIter.hasNext())
            {
                ...
                PDFTextStripper.PositionWrapper current = new PDFTextStripper.PositionWrapper(position);
                ...
                if (lastPosition != null)
                {
                    ...
                    {
                        line.add(PDFTextStripper.LineItem.getWordSeparator());
                    }
                }
                ...
                if (characterValue != null)
                {
                    ...
                    line.add(new PDFTextStripper.LineItem(position));
                }
    ...
    protected void writeString(String text, TextPosition boundingPosition) throws IOException
    {
        writeString(text);
    }
     ...
     */
    private PDFTextStripper.PositionWrapper handleLineSeparation(PDFTextStripper.PositionWrapper current,
     ...
     */
    private void isParagraphSeparation(PDFTextStripper.PositionWrapper position,
                                       PDFTextStripper.PositionWrapper lastPosition,
                                       PDFTextStripper.PositionWrapper lastLineStartPosition, float maxHeightForLine)
    {
     ...
     */
    private Pattern matchListItemPattern(PDFTextStripper.PositionWrapper pw)
    {
     ...
     * @throws IOException if something went wrong
     */
    private void writeLine(List<PDFTextStripper.WordWithTextPositions> line)
            throws IOException
    {
     ...
     */
    private List<PDFTextStripper.WordWithTextPositions> normalize(List<PDFTextStripper.LineItem> line)
    {
        List<PDFTextStripper.WordWithTextPositions> normalized = new LinkedList<WordWithTextPositions>();
    ...
    static
    {
        ...
        InputStream input = org.apache.pdfbox.text.PDFTextStripper.class.getClassLoader().getResourceAsStream(path);
        try
        {
            if (input != null)
            {
     ...
     */
    private PDFTextStripper.WordWithTextPositions createWord(String word, List<TextPosition> wordPositions)
    {
        return new PDFTextStripper.WordWithTextPositions(normalizeWord(word), wordPositions);
    }
     ...
     */
    private StringBuilder normalizeAdd(List<PDFTextStripper.WordWithTextPositions> normalized,
    ...
    {
        public static PDFTextStripper.LineItem WORD_SEPARATOR = new PDFTextStripper.LineItem();

        public static PDFTextStripper.LineItem getWordSeparator()
        {
